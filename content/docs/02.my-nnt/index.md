...
::card-group
  ::card{icon="i-lucide-ticket" title="Booking tickets" to="/docs/my-nnt/booking-tickets"}
  Finding a show, holding seats online and paying at the desk on the night.
  ::
  ::card{icon="i-lucide-qr-code" title="Your booking" to="/docs/my-nnt/your-booking"}
  The booking page behind the QR code: changing, exchanging and cancelling while unpaid.
  ::
  ::card{icon="i-lucide-wallet-cards" title="Passes" to="/docs/my-nnt/passes"}
  Requesting a pass, collecting it at the desk and using it to book.
  ::
  ::card{icon="i-lucide-clock" title="Waiting list" to="/docs/my-nnt/waiting-list"}
...
::card-group
  ::card{icon="i-lucide-door-open" title="Book a room" to="/docs/my-nnt/book-a-room"}
...
::card-group
  ::card{icon="i-lucide-accessibility" title="Access requirements" to="/docs/my-nnt/access-requirements"}
...
::card-group
  ::card{icon="i-lucide-receipt" title="My tab" to="/docs/my-nnt/my-tab"}

...
and the IT Manager is told. Drift is a defect, not a chore.
...
::card-group
  ...
  Settings, the audit trail, backups and restore, and how this documentation is kept.
  ::
::
...
::card-group
  ...
  ::
  ::card{icon="i-lucide-users" title="People" to="/docs/people"}

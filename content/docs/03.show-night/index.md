...
- **"This needs a confirmed DOOR shift on one of tonight's performances, or the front of house
  manager's role"** (or the same for BAR and the bar manager, or DUTY_MANAGER): nothing tonight
  gives you this screen. Find the person named, or ask the officer to assign you the shift on

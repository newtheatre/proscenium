...
// The content warnings list's declaration (K-129). Search runs over title and slug, since two
// entries can share neither (D-102); GENERAL warnings always list ahead of the rest, fixed at the
// query, so only the tiebreak after that is a declared sort.

...
const CATALOGUE = {
  ...
  'bar.sumup.started': { label: 'A basket handed to the SumUp app', module: 'bar' },
  'bar.sumup.claimed': { label: 'A SumUp answer claimed for recording', module: 'bar' },
  'bar.sumup.completed': { label: 'A SumUp payment recorded as a sale', module: 'bar' },
  'bar.sumup.mismatched': { label: 'A SumUp payment taken but not recordable', module: 'bar' },
  'bar.sumup.resolved': { label: 'A SumUp hand-off failed, abandoned or reset', module: 'bar' },

...
const CATALOGUE = {
  ...
  'bar.sumup.completed': { label: 'Card charge recorded as a sale', module: 'bar' },
  'bar.sumup.mismatched': { label: 'Card charge taken but not recordable', module: 'bar' },
  'bar.sumup.resolved': { label: 'Card charge declined, failed, abandoned or reset', module: 'bar' },

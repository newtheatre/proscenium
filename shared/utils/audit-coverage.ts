...
export const AUDIT_COVERAGE: Coverage[] = [
  ...
  { route: 'server/api/till/sale.post.ts', exempt: 'cross-checks the submitted total against live prices; nothing is written until F-105 lands the atomic sale write' },

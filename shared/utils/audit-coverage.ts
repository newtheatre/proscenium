...
export const AUDIT_COVERAGE: Coverage[] = [
  ...
  { route: 'server/api/admin/reference-data/seasons/index.get.ts', exempt: 'reads the seasons, retired ones included' },
  { route: 'server/api/admin/reference-data/seasons/index.post.ts', actions: ['season.created'] },
  { route: 'server/api/admin/reference-data/seasons/[id]/index.put.ts', actions: ['season.updated'] },
  { route: 'server/api/admin/reference-data/seasons/[id]/archive.post.ts', actions: ['season.archived', 'season.restored'] },
  { route: 'server/api/admin/reference-data/seasons/[id]/index.delete.ts', actions: ['season.deleted'] },
  { route: 'server/api/admin/reference-data/show-categories/index.get.ts', exempt: 'reads the show categories, retired ones included' },
  { route: 'server/api/admin/reference-data/show-categories/index.post.ts', actions: ['show-category.created'] },
  { route: 'server/api/admin/reference-data/show-categories/[id]/index.put.ts', actions: ['show-category.updated'] },
  { route: 'server/api/admin/reference-data/show-categories/[id]/archive.post.ts', actions: ['show-category.archived', 'show-category.restored'] },
  { route: 'server/api/admin/reference-data/show-categories/[id]/index.delete.ts', actions: ['show-category.deleted'] },
  ...
  { route: 'server/api/account/access-profile.put.ts', actions: ['access-profile.updated', 'access-profile.consent.changed'], via: ['server/utils/access-profiles.ts'] },
  { route: 'server/api/account/access-profile/consent.put.ts', actions: ['access-profile.consent.changed'], via: ['server/utils/access-profiles.ts'] },
  ...
  { route: 'server/api/till/close.post.ts', actions: ['bar.till.closed'], via: ['server/utils/reconciliation.ts'] },
  { route: 'server/api/till/[id]/reconciliation.get.ts', exempt: 'reads the expected figure before anyone commits to closing, writing nothing' },
  ...
  { route: 'server/api/admin/finance/seasons.get.ts', exempt: 'reads the seasons table, writing nothing' },

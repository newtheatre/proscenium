#!/usr/bin/env bun
// The old proscenium programme alone (K-113); build.ts runs the same step in sequence.
import { Database } from 'bun:sqlite'
import { assertLocalTarget, assertNotProduction } from '../tests/helpers/seed'
import { latestStamp } from './lib'
import { closeDumps, openDumps, stepProgramme } from './steps'
...
const { summary, exceptions, problems } = await stepProgramme(dumps, target)

#!/usr/bin/env bun
// Reservations, seats and reconstructed passes alone (0073); build.ts runs the same step in sequence.
import { Database } from 'bun:sqlite'
import { assertLocalTarget, assertNotProduction } from '../tests/helpers/seed'
import { latestStamp } from './lib'
import { closeDumps, openDumps, stepReservations } from './steps'
...
const { summary, exceptions, problems } = await stepReservations(dumps, target)

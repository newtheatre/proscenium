...
| 3 | A-119 · H-108 · K-114 + I-109 · K-116 · J-105 | K-116 needs F-115 (bar wave 2) and, inside this module, K-113 (platform wave 2): the backlog's own `Depends on: K-113` is a hard dependency F-115 does not clear on its own, because K-113 is the keyed-merge import tooling K-116's criteria 1 and 2 build on. K-113 in turn needs K-112. Criteria 3 and 4 read as already met by F-115's `apply.post.ts`, so the pull request that finally opens K-116 may be smaller than its four criteria suggest. |
...
| F-115; K-116 | Stocktake apply | Hard dependency; two waves apart. Necessary, not sufficient: K-116 also depends on K-113 inside platform's own module (`Depends on: K-113`, `backlog/K-platform.md`), which this row did not record and which F-115 merging does not clear. |

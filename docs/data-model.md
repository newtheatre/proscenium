...
**Retries are attempts on the same row, never new rows (H-105, 0055).** `attempts` counts provider
...
appears in no customer or operator response (0055; H-106 criterion 3). A message carrying an

...
- **GP scales cost by depletion.** A 175 ml glass costs 233 thousandths of its bottle's latest
  delivery cost, not a whole one (`docs/13` §3.1). A product with no delivery recorded has a null
  cost rather than a flattering zero.

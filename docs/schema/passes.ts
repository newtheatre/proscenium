/**
 * server/db/schema/passes.ts — PROPOSED, not yet in the app.
 *
 * Season passes and festival passes. Design and rationale:
 ...
 *
 * Depends on `ticket_types.kind`, added by migration 0009 (legacy import).
 */

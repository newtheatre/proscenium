...
265 stories across 11 modules. Detailed stories carry testable acceptance criteria; Later
...
all files are the agenda feed for the workshops in `../workshops.md`. MVP totals 202 stories,

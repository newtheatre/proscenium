...
285 stories across 11 modules. Detailed stories carry testable acceptance criteria; Later
...
| `J-governance.md` | Governance and handover | 10 | 3 | 0 | 14 |
| `K-platform.md` | Platform foundations and migration | 25 | 0 | 0 | 28 |
| **Total** | | **211** | **43** | **20** | **285** |
...
all files are the agenda feed for the workshops in `../workshops.md`. MVP totals 211 stories,

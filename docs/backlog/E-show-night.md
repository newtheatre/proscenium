...
- Source: Matt's direction of 15 September 2026 (the ad-hoc shift is a bar opening record); decision 0077; module F open question 5; issue 1216 (criterion 8, the board showed only performances, so an officer planning the fortnight could not see a hire night's staffing beside the shows).

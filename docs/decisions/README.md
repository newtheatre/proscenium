...
| 0087 | The whole-year period is a year, and a season is Autumn, Spring, StuFF or the Fringe | why the 1 August to 31 July period is renamed `YEAR` everywhere, what the theatre means by a season, and the open question of how a season's days are known, with the `seasons` table recommended over configured dates or attribution by show |

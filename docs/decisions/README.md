...
| 0085 | Visibly over 25 is a till answer, not a register entry | why the till's Challenge 25 prompt gained a first answer that writes nothing, why the register's outcome column cannot take a third value under 0010, where the basis of an unchallenged restricted sale is recorded instead, and why the standalone register never offers it |

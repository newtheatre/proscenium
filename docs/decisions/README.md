...
| 0100 | The delivered cost of measured stock is held per container | why whole pence a millilitre kept a £6.50 bottle as £7.50 and a £1.20 mixer as nothing, why a delivery now records what one container cost and what it held, why the cost is divided only when a report reads it and rounded once, why no row is rescaled, and why tenths of a penny and pence a litre lost. Touches 0004 and 0010. Proposed |

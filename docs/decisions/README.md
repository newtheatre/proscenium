...
| 0061 | An anonymised holder never admits, on the pass that was theirs | why a pass redemption takes both an app-level refusal and a predicate term, where 0059 and 0060 each took only one |

...
| 13 | [Bar: design](./13-bar-design.md) | The counter till, the stock ledger, Challenge 25, the daily reconciliation. **Agreed Aug 2026, largely built.** | Implementing the bar |

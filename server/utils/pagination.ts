 ...
 * optionally `q`, and always return the `Paginated<T>` envelope.
 */
...
// `Paginated<T>` lives in shared/types and is auto-imported both sides. Not
// re-exported here: two auto-imports of one name is a build warning.

...
import { CONFIG_KEYS, hasDefault, isSynced } from '#shared/utils/config'
...
export function refuseSynced(key: ConfigKey): void {
  ...
  throw createError({
    statusCode: 409,
    statusMessage: 'This setting is copied from gov.uk every week and cannot be changed by hand. Use Sync now instead.',
  })
}

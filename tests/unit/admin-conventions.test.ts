...
// page (K-123 criterion 9, J-109, issue 1151 item 2). Three shapes carry the rule.
...
describe('a console screen introduces itself in one sentence (K-123 criterion 9, issue 1151 item 2)', () => {

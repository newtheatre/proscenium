...
async function load(): Promise<void> {
  try {
    const answered = await request<{ messages: Message[], acknowledgements: Acknowledgement[] }>('/api/tonight/board/messages')
...
async function reset(): Promise<void> {
  ...
  try {
    await $fetch('/api/tonight/board/reset', { method: 'POST' })
